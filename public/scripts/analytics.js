/* Add segment.com analytics as described
...
!(function () {
  ...
  if (
    ...
    window.runtimeConfig.hasOwnProperty("analyticsWriteKey")
  ) {
    writeKey = window.runtimeConfig.analyticsWriteKey;
  } else {
    writeKey = "%REACT_APP_ANALYTICS_WRITE_KEY%";
  }
