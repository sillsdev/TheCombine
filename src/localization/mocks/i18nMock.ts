 ...
 * (In most cases, this isn't needed. Instead you can use
 * localization/mocks/reactI18nextMock.ts to mock out i18n completely.)
 * For a simple i18next wrapper, add the following to a test file:
 * * import { I18nextProvider } from "react-i18next";
 * * import i18n from "localization/mocks/i18nMock";
