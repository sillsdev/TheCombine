...
export interface RegisterInviteDispatchProps {
  register?: (
    name: string,
    user: string,
    email: string,
...
export interface RegisterInviteStateProps {
  inProgress: boolean;
  success: boolean;
...
class RegisterInvite extends React.Component<
  RegisterInviteDispatchProps & RegisterInviteStateProps & LocalizeContextProps,
  RegisterInviteState
> {
  constructor(
    props: RegisterInviteDispatchProps &
  ...
  updateField<K extends keyof RegisterInviteState>(
    e: React.ChangeEvent<
...
export default withLocalize(RegisterInvite);
