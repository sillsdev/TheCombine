...
export default async function (start?: string, exclude?: string[]): Promise<[string?,string?]> {
  ...
  switch (startCode) {
    case "97":
      return [startCode, (await import("resources/dictionaries/es/u97.dic")).default];
    case "97-98":
    ...
    case "99":
      return [startCode, (await import("resources/dictionaries/es/u99.dic")).default];
    case "99-97":
    ...
    case "101":
      return [startCode, (await import("resources/dictionaries/es/u101.dic")).default];
    case "101-109":
