...
import { Box, CardContent, Card, Popper, ClickAwayListener } from "@material-ui/core";
...
class MergeStack extends React.Component<
	...
	spawnDisplay(e: React.MouseEvent<HTMLElement>) {
		this.setState({ ...this.state, anchorEl: this.state.anchorEl ? undefined : e.currentTarget });
	}
