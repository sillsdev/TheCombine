...
!!! tip "Tips"
    ...
    Untuk mempercepat pencarian medan, The Combine akan secara otomatis menyisipkan `.` di antara digit-digit
    berurutan saat Anda mengetik. Contohnya, `1234` akan otomatis menjadi `1.2.3.4`. Perilaku ini tidak terjadi
    jika ada karakter non-numerik yang dimasukkan.
