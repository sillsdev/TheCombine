...
!!! note "Catatan"
    ...
    Jika seorang Administrator proyek telah mengaktifkan pengaturan
    [Harvester Review Entries](project.md#harvester-review-entries), Pengumpul juga dapat menggunakan Tinjau Entri.
...
!!! tip "Tips"
    ...
    Anda mungkin perlu menggulir untuk melihat panelnya. Jika jendela Anda cukup lebar, akan ada margin kosong di
    sebelah kanan; panel akan berada di bagian atas margin ini. Jika jendela Anda sempit, ubin memenuhi hingga ke sisi kanan
    jendela; panel akan berada di bagian bawah, di bawah semua ubin.
