...
namespace BackendFramework.Controllers
{
    ...
    public class LiftController(IProjectRepository projRepo, ISpeakerRepository speakerRepo, IWordRepository wordRepo,
        IPermissionService permissionService, ILiftService liftService, IHubContext<ExportHub> notifyService,
        ILogger<LiftController> logger) : Controller
    {
        ...
        {
            return await _liftService.LiftExport(projectId, _projRepo, _speakerRepo, _wordRepo);
        }
