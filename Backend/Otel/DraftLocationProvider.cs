...
// {
//     public class DraftLocationProvider
//     {
//         public const string locationGetterUri = "http://ip-api.com/json/";
//         private readonly IHttpContextAccessor _contextAccessor;
//         private readonly IMemoryCache _memoryCache;
//         private readonly IHttpClientFactory _httpClientFactory;
//         public DraftLocationProvider(IHttpContextAccessor contextAccessor, IMemoryCache memoryCache, IHttpClientFactory httpClientFactory)
//         {
...
//                 LocationApi? location = await GetLocationWithCaching(ipAddressWithoutPort);
//                 return location;
//             }
//             return null;
//         }

//         public Task<LocationApi?> GetLocationWithCaching(string ipAddressWithoutPort)
//         {

//             var location = _memoryCache.GetOrCreateAsync(
