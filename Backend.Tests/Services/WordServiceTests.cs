...
namespace Backend.Tests.Services
{
    public class WordServiceTests
    {
        ...
        [Test]
        public void FindExistingDuplicateNoFrontierEmpty()
        {
            var newWord = Util.RandomWord(ProjId);

            var dupId = _wordService.FindExistingDuplicate(newWord).Result;
        ...
        [Test]
        public void FindExistingDuplicateNewVernEmpty()
        {
            var oldWordSameProj = Util.RandomWord(ProjId);
            _ = _wordRepo.Create(oldWordSameProj).Result;
            var oldWordDiffProj = Util.RandomWord("different");
        ...
        [Test]
        public void FindExistingDuplicateSameVernSubsetSenseId()
        {
            var oldWord = Util.RandomWord(ProjId);
            var newWord = Util.RandomWord(ProjId);
            newWord.Vernacular = oldWord.Vernacular;
        ...
        [Test]
        public void FindExistingDuplicateSameVernEmptySensesDiffDomsEmpty()
        {
            var oldWord = Util.RandomWord(ProjId);
            oldWord = _wordRepo.Create(oldWord).Result;
            var newWord = Util.RandomWord(ProjId);
        ...
        [Test]
        public void FindExistingDuplicateSameVernEmptySensesSameDomsId()
        {
            var oldWord = Util.RandomWord(ProjId);
            var newWord = Util.RandomWord(ProjId);
            newWord.Vernacular = oldWord.Vernacular;
