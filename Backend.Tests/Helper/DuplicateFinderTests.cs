...
namespace Backend.Tests.Helper
{
    public class DuplicateFinderTests
    {
        ...
        private Func<List<string>, Task<bool>> _isInGraylist = null!;
        ...
        public void Setup()
        {
            ...
            _isInGraylist = _ => Task.FromResult(false);
        }
        ...
        public void GetSimilarWordsAndMaxInListAndMaxListsTest()
        {
            ...
            var wordLists = _dupFinder.GetSimilarWords(_frontier, _isInBlacklist, _isInGraylist).Result;
